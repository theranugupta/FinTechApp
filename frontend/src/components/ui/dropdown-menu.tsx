...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        // Frosted card with a subtle gradient sheen + soft brand ring.
        "z-50 min-w-[12rem] overflow-hidden rounded-xl border border-border/60 bg-popover/95 p-1.5 text-popover-foreground shadow-xl backdrop-blur-md",
